...
final class Version20240109145025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (Email VARCHAR(255) NOT NULL, EnglishLevel SMALLINT DEFAULT NULL, NativeLanguage VARCHAR(255) NOT NULL, Gender SMALLINT DEFAULT NULL, Education VARCHAR(255) DEFAULT NULL, referrer VARCHAR(255) DEFAULT NULL, Country VARCHAR(255) DEFAULT NULL, IsInterestedInMoreInfo TINYINT(1) DEFAULT NULL, PRIMARY KEY(Email)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
